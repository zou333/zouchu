  ...
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
      <tr>
        ...
        <th style="text-align:left; padding-left:20px;">地址</th>
        <th style="text-align:left; padding-left:20px;">网址</th>
        <th style="text-align:left; padding-left:20px;">邮箱</th>
        <th style="text-align:left; padding-left:20px;">电话</th>
        <th style="text-align:left; padding-left:20px;">QQ</th>
        <th width="310">操作</th>
      </tr>
	  <?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
          <td><font color="#00CC99"><?php echo ($value['id']); ?></font></td>
          <td style="text-align:left; padding-left:20px;"><?php echo ($value['address']); ?></td>
          <td style="text-align:left; padding-left:20px;"><?php echo ($value['http']); ?></td>
          <td style="text-align:left; padding-left:20px;"><?php echo ($value['email']); ?></td>
          <td style="text-align:left; padding-left:20px;"><?php echo ($value['phone']); ?></td>
          <td style="text-align:left; padding-left:20px;"><?php echo ($value['qq']); ?></td>
