...
<form method="get" action="<?php echo U();?>" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 商品模型列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
    ...
    <table class="table table-hover text-center">
      <tr>
        ...
        <th style="text-align:left; padding-left:20px;">商品类型</th>
        <th width="310">操作</th>
      </tr>
	  <?php if(is_array($info)): foreach($info as $key=>$value): ?><tr>
          ...
          <td><div class="button-group"> <a class="button border-main" href="<?php echo U('edit',['id'=>$value['id']]);?>"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="javascript:void(0)" onclick="return spec_del(<?php echo ($value['id']); ?>)"><span class="icon-trash-o"></span> 删除</a> </div></td>
